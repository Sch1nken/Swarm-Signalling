...
const server = HttpsServer({
	cert: fs.readFileSync("/etc/letsencrypt/live/dev.bytesandpieces.xyz/fullchain.pem"),
	key: fs.readFileSync("/etc/letsencrypt/live/dev.bytesandpieces.xyz/privkey.pem")
}).listen(PORT);
